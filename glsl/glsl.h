...
class C_GLShaderManager {
	public :
		...
		C_GLShader *LoadShaderProgram(const char *vertSource, const char *fragSource);
		C_GLShader *LoadShaderProgramFromFiles(const char *vertSourceFileName, const char *fragSourceFileName);
